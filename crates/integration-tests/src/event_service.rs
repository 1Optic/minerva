...
mod tests {
    ...
    use crate::minerva_event_service::{MinervaEventService, MinervaEventServiceConfig};
    ...
    #[tokio::test]
    async fn publish_notification_events() -> Result<(), Box<dyn std::error::Error>> {
        crate::setup();
...

        {
            ...
            let service_conf = MinervaEventServiceConfig {
            ...
            let mut service = MinervaEventService::start(service_conf)?;
