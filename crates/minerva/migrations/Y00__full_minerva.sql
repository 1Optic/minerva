...
--
-- Name: timestamp_statistics; Type: TYPE; Schema: trend_directory; Owner: postgres
--
...
ALTER TYPE trend_directory.timestamp_statistics OWNER TO postgres;
...
CREATE TABLE trend_directory.materialization (
    ...
    old_data_stability_delay interval,
    old_data_threshold interval
);
...
--
-- Name: create_entity_type(text, text); Type: FUNCTION; Schema: directory; Owner: postgres
--

CREATE FUNCTION directory.create_entity_type(entity_type_name text, primary_alias text) RETURNS directory.entity_type
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION directory.create_entity_type(entity_type_name text, primary_alias text) OWNER TO postgres;

--
-- Name: define_entity_type(text, text, text); Type: FUNCTION; Schema: directory; Owner: postgres
--

CREATE FUNCTION directory.define_entity_type(entity_type_name text, primary_alias text, description text) RETURNS directory.entity_type
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION directory.define_entity_type(entity_type_name text, primary_alias text, description text) OWNER TO postgres;
...
--
-- Name: init_entity_type(directory.entity_type, text); Type: FUNCTION; Schema: directory; Owner: postgres
--

CREATE FUNCTION directory.init_entity_type(directory.entity_type, primary_alias text) RETURNS directory.entity_type
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION directory.init_entity_type(directory.entity_type, primary_alias text) OWNER TO postgres;
...
--
-- Name: update_entity_type(text, text, text); Type: FUNCTION; Schema: directory; Owner: postgres
--

CREATE FUNCTION directory.update_entity_type(entity_type_name text, primary_alias text, description text) RETURNS directory.entity_type
    LANGUAGE plpgsql
    AS $_$
    DECLARE
...
ALTER FUNCTION directory.update_entity_type(entity_type_name text, primary_alias text, description text) OWNER TO postgres;
...
--
-- Name: template-trigger-notification_staging_insert_checks(); Type: FUNCTION; Schema: notification; Owner: postgres
--

CREATE FUNCTION notification."template-trigger-notification_staging_insert_checks"() RETURNS trigger
...
ALTER FUNCTION notification."template-trigger-notification_staging_insert_checks"() OWNER TO postgres;
...
CREATE FUNCTION relation_directory.create_entity_set(name text, "group" text, entity_type_name text, owner text, description text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
  entity_id integer;
...
CREATE TABLE trend_directory.table_trend (
    ...
    staged_for_deletion timestamp with time zone,
    deletion_staging_column text
);
...
--
-- Name: create_statistics_for_table_trend(); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.create_statistics_for_table_trend() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION trend_directory.create_statistics_for_table_trend() OWNER TO postgres;
...
--
-- Name: define_function_materialization(integer, interval, interval, interval, regproc, jsonb, interval, interval); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.define_function_materialization(dst_trend_store_part_id integer, processing_delay interval, stability_delay interval, reprocessing_period interval, src_function regproc, description jsonb, old_data_threshold interval, old_data_stability_delay interval) RETURNS trend_directory.function_materialization
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION trend_directory.define_function_materialization(dst_trend_store_part_id integer, processing_delay interval, stability_delay interval, reprocessing_period interval, src_function regproc, description jsonb, old_data_threshold interval, old_data_stability_delay interval) OWNER TO postgres;

--
-- Name: FUNCTION define_function_materialization(dst_trend_store_part_id integer, processing_delay interval, stability_delay interval, reprocessing_period interval, src_function regproc, description jsonb, old_data_threshold interval, old_data_stability_delay interval); Type: COMMENT; Schema: trend_directory; Owner: postgres
--
...
--
-- Name: define_materialization(integer, interval, interval, interval, jsonb, interval, interval); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.define_materialization(dst_trend_store_part_id integer, processing_delay interval, stability_delay interval, reprocessing_period interval, description jsonb, old_data_threshold interval, old_data_stability_delay interval) RETURNS trend_directory.materialization
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION trend_directory.define_materialization(dst_trend_store_part_id integer, processing_delay interval, stability_delay interval, reprocessing_period interval, description jsonb, old_data_threshold interval, old_data_stability_delay interval) OWNER TO postgres;

--
-- Name: FUNCTION define_materialization(dst_trend_store_part_id integer, processing_delay interval, stability_delay interval, reprocessing_period interval, description jsonb, old_data_threshold interval, old_data_stability_delay interval); Type: COMMENT; Schema: trend_directory; Owner: postgres
--
...
--
-- Name: define_trend_store_part(integer, name, boolean); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.define_trend_store_part(trend_store_id integer, name name, primary_alias boolean) RETURNS trend_directory.trend_store_part
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION trend_directory.define_trend_store_part(trend_store_id integer, name name, primary_alias boolean) OWNER TO postgres;
...
--
-- Name: define_trend_store_part(integer, name, boolean, trend_directory.trend_descr[], trend_directory.generated_trend_descr[]); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.define_trend_store_part(trend_store_id integer, name name, primary_alias boolean, trends trend_directory.trend_descr[], generated_trends trend_directory.generated_trend_descr[]) RETURNS trend_directory.trend_store_part
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION trend_directory.define_trend_store_part(trend_store_id integer, name name, primary_alias boolean, trends trend_directory.trend_descr[], generated_trends trend_directory.generated_trend_descr[]) OWNER TO postgres;
...
--
-- Name: define_view_materialization(integer, interval, interval, interval, regclass, jsonb, interval, interval); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.define_view_materialization(dst_trend_store_part_id integer, processing_delay interval, stability_delay interval, reprocessing_period interval, src_view regclass, description jsonb, old_data_threshold interval, old_data_stability_delay interval) RETURNS trend_directory.view_materialization
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION trend_directory.define_view_materialization(dst_trend_store_part_id integer, processing_delay interval, stability_delay interval, reprocessing_period interval, src_view regclass, description jsonb, old_data_threshold interval, old_data_stability_delay interval) OWNER TO postgres;

--
-- Name: FUNCTION define_view_materialization(dst_trend_store_part_id integer, processing_delay interval, stability_delay interval, reprocessing_period interval, src_view regclass, description jsonb, old_data_threshold interval, old_data_stability_delay interval); Type: COMMENT; Schema: trend_directory; Owner: postgres
--
...
--
-- Name: ensure_name_column(trend_directory.trend_store_part); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.ensure_name_column(trend_directory.trend_store_part) RETURNS void
    LANGUAGE plpgsql
    AS $_$
    DECLARE
        entity_type text;
...
ALTER FUNCTION trend_directory.ensure_name_column(trend_directory.trend_store_part) OWNER TO postgres;
...
--
-- Name: function_materialization_columns(integer); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.function_materialization_columns(materialization_id integer) RETURNS TABLE(name name)
    LANGUAGE sql STABLE
    AS $_$
...
ALTER FUNCTION trend_directory.function_materialization_columns(materialization_id integer) OWNER TO postgres;

--
-- Name: FUNCTION function_materialization_columns(materialization_id integer); Type: COMMENT; Schema: trend_directory; Owner: postgres
--
...
--
-- Name: get_highest_trend_value(text, text); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.get_highest_trend_value(trend_store_part text, trend text) RETURNS numeric
    LANGUAGE plpgsql STABLE
    AS $_$
DECLARE
  result numeric;
...
ALTER FUNCTION trend_directory.get_highest_trend_value(trend_store_part text, trend text) OWNER TO postgres;
...
--
-- Name: get_lowest_trend_value(text, text); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.get_lowest_trend_value(trend_store_part text, trend text) RETURNS numeric
    LANGUAGE plpgsql STABLE
    AS $_$
DECLARE
  result numeric;
...
ALTER FUNCTION trend_directory.get_lowest_trend_value(trend_store_part text, trend text) OWNER TO postgres;
...
--
-- Name: remove_name_column(trend_directory.trend_store_part); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.remove_name_column(trend_directory.trend_store_part) RETURNS void
    LANGUAGE plpgsql
    AS $_$
    BEGIN
...
ALTER FUNCTION trend_directory.remove_name_column(trend_directory.trend_store_part) OWNER TO postgres;
...
--
-- Name: timestamp_statistics(name, timestamp with time zone); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--
...
ALTER FUNCTION trend_directory.timestamp_statistics(trend_store_part name, timestamp with time zone) OWNER TO postgres;
...
--
-- Name: update_statistics(trend_directory.table_trend); Type: FUNCTION; Schema: trend_directory; Owner: postgres
--

CREATE FUNCTION trend_directory.update_statistics(trend_directory.table_trend) RETURNS record
    LANGUAGE plpgsql
    AS $_$
  DECLARE
    tspname text;
...
ALTER FUNCTION trend_directory.update_statistics(trend_directory.table_trend) OWNER TO postgres;
...
--
-- Name: template-trigger-notification; Type: TABLE; Schema: notification; Owner: minerva_writer
--

CREATE TABLE notification."template-trigger-notification" (
    id integer NOT NULL,
    entity_id integer NOT NULL,
    "timestamp" timestamp with time zone NOT NULL,
...
ALTER TABLE notification."template-trigger-notification" OWNER TO minerva_writer;

--
-- Name: template-trigger-notification_id_seq; Type: SEQUENCE; Schema: notification; Owner: minerva_writer
--

CREATE SEQUENCE notification."template-trigger-notification_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE notification."template-trigger-notification_id_seq" OWNER TO minerva_writer;

--
-- Name: template-trigger-notification_id_seq; Type: SEQUENCE OWNED BY; Schema: notification; Owner: minerva_writer
--

ALTER SEQUENCE notification."template-trigger-notification_id_seq" OWNED BY notification."template-trigger-notification".id;


--
-- Name: template-trigger-notification_staging; Type: TABLE; Schema: notification; Owner: minerva_writer
--

CREATE TABLE notification."template-trigger-notification_staging" (
    entity_id integer NOT NULL,
    "timestamp" timestamp with time zone NOT NULL,
    created timestamp with time zone,
    rule_id integer,
...
ALTER TABLE notification."template-trigger-notification_staging" OWNER TO minerva_writer;
...
CREATE TABLE trend_directory.materialization_state (
    ...
    max_modified timestamp with time zone,
    job_id bigint,
    materialization_count integer DEFAULT 0 NOT NULL
);
...
--
-- Name: table_trend_statistics; Type: TABLE; Schema: trend_directory; Owner: postgres
--
...
--
-- Name: template; Type: TABLE; Schema: trigger; Owner: postgres
--
...
CREATE TABLE trigger.template (
    ...
    sql_body text DEFAULT 'FALSE'::text NOT NULL
);
...
--
-- Name: template_id_seq; Type: SEQUENCE; Schema: trigger; Owner: postgres
--

CREATE SEQUENCE trigger.template_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE trigger.template_id_seq OWNER TO postgres;

--
-- Name: template_id_seq; Type: SEQUENCE OWNED BY; Schema: trigger; Owner: postgres
--

ALTER SEQUENCE trigger.template_id_seq OWNED BY trigger.template.id;


--
-- Name: template_parameter; Type: TABLE; Schema: trigger; Owner: postgres
--
...
CREATE TABLE trigger.template_parameter (
    ...
    has_lookback boolean DEFAULT false NOT NULL,
    lookback_parameter text
);
...
--
-- Name: template-trigger-notification id; Type: DEFAULT; Schema: notification; Owner: minerva_writer
--

ALTER TABLE ONLY notification."template-trigger-notification" ALTER COLUMN id SET DEFAULT nextval('notification."template-trigger-notification_id_seq"'::regclass);
...
--
-- Name: template id; Type: DEFAULT; Schema: trigger; Owner: postgres
--

ALTER TABLE ONLY trigger.template ALTER COLUMN id SET DEFAULT nextval('trigger.template_id_seq'::regclass);
...
--
-- Name: template-trigger-notification template-trigger-notification_pkey; Type: CONSTRAINT; Schema: notification; Owner: minerva_writer
--

ALTER TABLE ONLY notification."template-trigger-notification"
    ADD CONSTRAINT "template-trigger-notification_pkey" PRIMARY KEY (id);
...
--
-- Name: schema_history schema_history_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schema_history
    ADD CONSTRAINT schema_history_pkey PRIMARY KEY (version);
...
--
-- Name: template_parameter template_parameter_pkey; Type: CONSTRAINT; Schema: trigger; Owner: postgres
--

ALTER TABLE ONLY trigger.template_parameter
    ADD CONSTRAINT template_parameter_pkey PRIMARY KEY (template_id, name);


--
-- Name: template template_pkey; Type: CONSTRAINT; Schema: trigger; Owner: postgres
--

ALTER TABLE ONLY trigger.template
...
--
-- Name: idx_notification_template-trigger-notification_timestamp; Type: INDEX; Schema: notification; Owner: minerva_writer
--

CREATE INDEX "idx_notification_template-trigger-notification_timestamp" ON notification."template-trigger-notification" USING btree ("timestamp");
...
--
-- Name: ix_template_name; Type: INDEX; Schema: trigger; Owner: postgres
--
...
--
-- Name: template-trigger-notification_staging check_notifications_trigger; Type: TRIGGER; Schema: notification; Owner: minerva_writer
--

CREATE TRIGGER check_notifications_trigger BEFORE INSERT ON notification."template-trigger-notification_staging" FOR EACH ROW EXECUTE FUNCTION notification."template-trigger-notification_staging_insert_checks"();
...
--
-- Name: table_trend create_statistics_on_new_table_trend; Type: TRIGGER; Schema: trend_directory; Owner: postgres
--

CREATE TRIGGER create_statistics_on_new_table_trend AFTER INSERT ON trend_directory.table_trend FOR EACH ROW EXECUTE FUNCTION trend_directory.create_statistics_for_table_trend();
...
--
-- Name: table_trend_statistics table_trend_statistics_table_trend_id_fkey; Type: FK CONSTRAINT; Schema: trend_directory; Owner: postgres
--

ALTER TABLE ONLY trend_directory.table_trend_statistics
    ADD CONSTRAINT table_trend_statistics_table_trend_id_fkey FOREIGN KEY (table_trend_id) REFERENCES trend_directory.table_trend(id) ON DELETE CASCADE;
...
--
-- Name: TABLE "template-trigger-notification"; Type: ACL; Schema: notification; Owner: minerva_writer
--

GRANT SELECT ON TABLE notification."template-trigger-notification" TO minerva;


--
-- Name: TABLE "template-trigger-notification_staging"; Type: ACL; Schema: notification; Owner: minerva_writer
--

GRANT SELECT ON TABLE notification."template-trigger-notification_staging" TO minerva;
...
--
-- Name: TABLE template; Type: ACL; Schema: trigger; Owner: postgres
--

GRANT SELECT ON TABLE trigger.template TO minerva;
GRANT INSERT,DELETE,UPDATE ON TABLE trigger.template TO minerva_writer;


--
-- Name: SEQUENCE template_id_seq; Type: ACL; Schema: trigger; Owner: postgres
--

GRANT SELECT,USAGE ON SEQUENCE trigger.template_id_seq TO minerva_writer;


--
-- Name: TABLE template_parameter; Type: ACL; Schema: trigger; Owner: postgres
--

GRANT SELECT ON TABLE trigger.template_parameter TO minerva;
GRANT INSERT,DELETE,UPDATE ON TABLE trigger.template_parameter TO minerva_writer;
